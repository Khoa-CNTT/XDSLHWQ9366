...
import { profileData } from "../../constants/profileData"; // Import dữ liệu tĩnh
...
const Profile1 = () => {
  ...
  // Sử dụng dữ liệu tĩnh thay vì API
  useEffect(() => {
    setIsLoading(true);
    // Giả lập thời gian tải để giữ animation
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    // Giả lập cập nhật thành công (vì không dùng API)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-24 bg-gray-50">
        <div className="text-center p-8 bg-white rounded-xl shadow-md max-w-lg w-full">
          ...
          <p className="text-gray-700 text-xl font-medium">Profile not found</p>
        </div>
      </div>
    );
  }
